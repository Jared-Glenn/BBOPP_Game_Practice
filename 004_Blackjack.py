...
SPADES = chr(9824)
CLUBS = chr(9827)
# (A list of chr codes is at https://inventwith python.com/charactermap)
BACKSIDE = 'backside'
...
def main():
    ...
    Rules:
        ...
        Kings, Queens, and Jacks are worth their face value.
    ...
    while True: # Main game loop.
        # Check if the player has frun out of money:
        if money <= 0:
            print("You're broke!")
